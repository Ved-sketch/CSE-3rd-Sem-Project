...
class GUI:
    def __init__(self):
        ...
        # Bind scroll events for better user experience
    ...
    def greeting(self):
        ...
        subtitle = ctk.CTkLabel(
            self.main_frame, 
            text="Welcome to Finsight - Your Financial Intelligence Hub 📊", 
            font=("Arial", 16),
            text_color=("#2563eb", "#3b82f6")
        )
        subtitle.pack(pady=(0, 20))
        
        # Add stock widgets and charts
        self.create_stock_widgets()
        
        # Load news after greeting
        self.load_news()
    ...
    def display_financial_news(self, data):
        ...
        articles = data.get('items', [])[:12]  # Show top 12 financial articles
        ...
        for i, article in enumerate(articles):
            ...
            def on_enter(event, frame=article_frame):
                frame.configure(border_color=("#4a9eff", "#60a5fa"))
                
            def on_leave(event, frame=article_frame):
                frame.configure(border_color=("#d4d4d8", "#3f3f46"))
                
            article_frame.bind("<Enter>", on_enter)
            article_frame.bind("<Leave>", on_leave)
